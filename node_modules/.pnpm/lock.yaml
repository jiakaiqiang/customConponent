...
importers:
  ...
  paly:
    ...
    devDependencies:
      '@vitejs/plugin-vue':
        specifier: ^4.2.3
        version: 4.2.3(vite@4.4.7)(vue@3.2.36)
      vite:
        specifier: ^4.4.7
        version: 4.4.7
...
packages:
  ...
  /@vitejs/plugin-vue@4.2.3(vite@4.4.7)(vue@3.2.36):
  ...
  /@vue-macros/common@1.6.0(vue@3.2.36):
  ...
  /unplugin-vue-define-options@1.3.12(vue@3.2.36):
    resolution: {integrity: sha512-0du2nVYAn7wMj2O90cIT8vtoYuWZdZ0G85+Z5TLORhjNsJEUneGjBxZ++CnlCM7YZxOHNun/wpWfCP8av9Cldw==}
    engines: {node: '>=16.14.0'}
    dependencies:
      '@vue-macros/common': 1.6.0(vue@3.2.36)
      ast-walker-scope: 0.4.2
